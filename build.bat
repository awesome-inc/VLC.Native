...
:unzip_dist
echo Unzipping.
if not exist dist\x86\vlc-%version%\vlc.exe 7z x %dist32% -odist\x86 > nul
if not exist dist\x64\vlc-%version%\vlc.exe 7z x %dist64% -odist\x64 > nul
